...
Ubuntu:
```bash
blender ./blender-projects/ActorCore-Walk-Relaxed.blend --python ./scripts/examples/export_actorcore_reset_pose.py
```

Windows:
```powershell
D:\Documents\Blender\blender.exe .\blender-projects\ActorCore-Walk-Relaxed.blend --python scripts\examples\export_actorcore_reset_pose.py
```
"""
...
save_path = "./data/motions/actorcore_reset_pose.npz"
